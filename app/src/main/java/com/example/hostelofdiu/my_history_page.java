...
public class my_history_page extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_history_page);
        ...
        back_btn = findViewById(R.id.history_page_back_bnt_id);
        recyclerView = findViewById(R.id.history_page_recview_id);

        request_list = new ArrayList<>();
        adapter = new myRoom_adapter(request_list, this,"history");
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for (DocumentSnapshot documentSnapshot : list) {
                            if(documentSnapshot.getString("application_condition").equals("leaved")||
                                    documentSnapshot.getString("application_condition").equals("rejected")) {
